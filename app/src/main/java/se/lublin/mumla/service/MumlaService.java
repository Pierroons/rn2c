...
public class MumlaService extends HumlaService implements
    ...
    private TextToSpeech.OnInitListener mTTSInitListener = new TextToSpeech.OnInitListener() {
        ...
        public void onInit(int status) {
            // Erreur TTS silencieuse — pas utile pour l'utilisateur
        }
    };
    ...
    // sendUserTextMessage et sendChannelTextMessage ne sont plus overridés ici :
    // l'écho serveur via onMessageLogged() gère l'ajout au log et au TTS (évite les doublons)
}
