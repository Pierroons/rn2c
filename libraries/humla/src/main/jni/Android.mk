...
LOCAL_SRC_FILES     := cb_search.c      exc_10_32_table.c   exc_8_128_table.c   filters.c \
                       ...
                       filterbank.c     scal.c \
                       $(ROOT)/jnispeex.cpp
LOCAL_CFLAGS           := -D__EMX__ -DUSE_KISS_FFT -DFIXED_POINT -DEXPORT='' -Wno-implicit-function-declaration -Wno-deprecated-non-prototype
...
LOCAL_CFLAGS        := -I$(ROOT)/celt-0.11.0-build -DHAVE_CONFIG_H -fvisibility=hidden -Wno-shift-op-parentheses -Wno-implicit-function-declaration -Wno-deprecated-non-prototype
LOCAL_CPP_FEATURES := exceptions
LOCAL_LDLIBS := -llog
LOCAL_LDFLAGS += "-Wl,-z,max-page-size=16384"
include $(BUILD_SHARED_LIBRARY)
...
LOCAL_CFLAGS        := -I$(ROOT)/celt-0.7.0-build -DHAVE_CONFIG_H -fvisibility=hidden -Wno-shift-op-parentheses -Wno-implicit-function-declaration -Wno-deprecated-non-prototype
LOCAL_CPP_FEATURES := exceptions
LOCAL_LDLIBS := -llog
LOCAL_LDFLAGS += "-Wl,-z,max-page-size=16384"
include $(BUILD_SHARED_LIBRARY)
