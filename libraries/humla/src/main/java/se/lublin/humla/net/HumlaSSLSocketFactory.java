...
public class HumlaSSLSocketFactory {
    ...
    public HumlaSSLSocketFactory(KeyStore keystore, String keystorePassword, String trustStorePath, String trustStorePassword, String trustStoreFormat) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException, NoSuchProviderException, IOException, CertificateException {
        this(keystore, keystorePassword, trustStorePath, trustStorePassword, trustStoreFormat, false);
    }

    public HumlaSSLSocketFactory(KeyStore keystore, String keystorePassword, String trustStorePath, String trustStorePassword, String trustStoreFormat, boolean trustAllServerCertificates) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException, NoSuchProviderException, IOException, CertificateException {
        ...
        if (trustAllServerCertificates) {
            mTrustWrapper = new HumlaTrustManagerWrapper(null, true);
            Log.i(TAG, "Trusting all server certificates (RN2C mode)");
    ...
    private static class HumlaTrustManagerWrapper implements X509TrustManager {
        ...
        public HumlaTrustManagerWrapper(X509TrustManager trustManager) throws NoSuchAlgorithmException, KeyStoreException {
            this(trustManager, false);
        }

        public HumlaTrustManagerWrapper(X509TrustManager trustManager, boolean trustAll) throws NoSuchAlgorithmException, KeyStoreException {
